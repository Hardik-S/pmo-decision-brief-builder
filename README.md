...
- Source note IDs are treated as usable evidence anchors. The builder rejects blank or duplicate IDs before citation coverage checks because missing or reused IDs would make sponsor-facing scoring and approval-gate references ambiguous.
